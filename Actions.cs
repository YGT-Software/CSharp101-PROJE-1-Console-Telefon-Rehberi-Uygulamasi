...
{
    public void addPerson(ref List<Person> directory)//Kişi ekleme fonksiyonu
    {
    ...
    public void deletePerson(ref List<Person> directory)//Kişi silme fonksiyonu
    {
    ...
    public void updateNumber(ref List<Person> directory)//Kişi güncelleme fonksiyonu
    {
    ...
    public void listingDirectory(ref List<Person> directory)//Rehber listeleme fonksiyonu
    {
    ...
    public void searchPerson(ref List<Person> directory)//Kişi arama fonksiyonu
    {
